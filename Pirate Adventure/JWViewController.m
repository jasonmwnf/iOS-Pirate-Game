...
- (void)viewDidLoad
{
    ...
    JWFactory *factory = [[JWFactory alloc] init];
...
- (IBAction)actionButtonPressed:(UIButton *)sender {
    JWTile *tile = [[self.tiles objectAtIndex:self.currentPoint.x] objectAtIndex:self.currentPoint.y];
...
-(void)updateTile
{
    JWTile * tileModel = [[self.tiles objectAtIndex:self.currentPoint.x] objectAtIndex:self.currentPoint.y];
...
-(void)updateCharacterStatsForArmor:(JWArmor *)armor withWeapons:(JWWeapon *) weapon withHealthEffect:(int)healthEffect
{
    if (armor != nil) {
